 ...
 * @author Carlos
 */
public class VistaSonidosAdmin extends javax.swing.JFrame {

    /**
     * Creates new form VistaSonidosAdmin
     */
     LinkedList<SonidoAdministrador> listaSonidosAdmin;
    
    public VistaSonidosAdmin() {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        SonidoAdministrador objU = new SonidoAdministrador(Visualizacion, Duracion, Usuario, Archivo, Descripcion, Fecha, Precio, idCategoria, idAdmin);
        boolean t = objCsa.insertarSonidoAdministrador(objU);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaSonidosAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaSonidosAdmin().setVisible(true);
            }
        });
    }
